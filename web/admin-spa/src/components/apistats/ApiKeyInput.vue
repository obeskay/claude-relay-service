<template>
  <div class="api-input-wide-card mb-8 rounded-3xl p-6 shadow-xl">
    ...
    <div class="wide-card-title mb-6">
      ...
      <p class="text-base text-muted-foreground">{{ t('apistats.input.query_subtitle') }}</p>
    </div>
    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div
        v-if="multiKeyMode"
        class="mt-2 rounded-lg bg-blue-50 p-3 text-sm text-primary dark:bg-blue-900/20 dark:text-blue-400"
      >
