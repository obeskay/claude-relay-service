        ...
        >
          ...
          <div class="rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
            <div class="flex items-start gap-3">
              <i class="fas fa-info-circle mt-1 text-primary" />
              <div>
                <p class="text-sm font-medium text-blue-800 dark:text-blue-300">批量编辑说明</p>
                <p class="mt-1 text-sm text-primary dark:text-blue-400">
              ...
              <div v-if="tagOperation !== 'none'" class="space-y-3">
                ...
                <div v-if="unselectedTags.length > 0">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button
                      ...
                      :key="'available-' + tag"
                      class="inline-flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 transition-colors hover:bg-blue-100 hover:text-primary dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-blue-900/30 dark:hover:text-blue-300"
                      type="button"
                      @click="selectTag(tag)"
                    >
                ...
                <div>
                  ...
                  <div class="flex gap-2">
                    <input
                      v-model="newTag"
                      class="form-input flex-1 border-border dark:bg-gray-800 dark:text-gray-200"
                      placeholder="输入新标签名称"
                      type="text"
          ...
          >
            <div class="mb-2 flex items-center gap-2">
              ...
              <h4 class="text-sm font-semibold text-foreground">速率限制设置</h4>
            </div>
          ...
          <div>
            ...
            <input
              ...
              class="form-input w-full border-border dark:bg-gray-800 dark:text-gray-200"
              min="0"
          ...
          <!-- 并发限制 -->
          <div>
            <label class="mb-3 block text-sm font-semibold text-foreground">并发限制</label>
            <input
          ...
          <div>
            <div class="mb-3 flex items-center gap-4">
              <label class="text-sm font-semibold text-foreground">激活状态</label>
              <div class="flex gap-4">
                <label class="flex cursor-pointer items-center">
                  <input v-model="form.isActive" class="mr-2" type="radio" :value="true" />
                  <span class="text-sm text-foreground">激活</span>
                </label>
                <label class="flex cursor-pointer items-center">
                  <input v-model="form.isActive" class="mr-2" type="radio" :value="false" />
                  <span class="text-sm text-foreground">禁用</span>
                </label>
                <label class="flex cursor-pointer items-center">
                  <input v-model="form.isActive" class="mr-2" type="radio" :value="null" />
                  <span class="text-sm text-foreground">不修改</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <!-- 服务权限 -->
          <div>
            <label class="mb-3 block text-sm font-semibold text-foreground">服务权限</label>
            <div class="flex flex-wrap gap-4">
              <label class="flex cursor-pointer items-center">
          ...
          <div>
            <div class="mb-3 flex items-center justify-between">
              <label class="text-sm font-semibold text-foreground">专属账号绑定</label>
              <button
